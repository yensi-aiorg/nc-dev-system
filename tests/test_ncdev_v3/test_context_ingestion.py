...
def test_ingest_project_context_ingests_expected_categories(tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("ncdev.v3.context_ingestion.CitexClient", FakeClient)
    # Skip Opus synthesis in tests
    monkeypatch.setattr("ncdev.v3.context_ingestion._synthesize_with_opus", lambda cat, raw: raw[:500])
