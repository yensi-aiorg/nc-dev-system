...
def _make_result():
    from ncdev.core.models import FixOutcome, SentinelFixResult
...
class TestSendFixResultSuccess:
    def test_success_on_first_call(self):
        ...
        with patch("ncdev.core.sentinel_callback.httpx.post", return_value=mock_response) as mock_post:
...
class TestSendFixResultRetry:
    def test_retries_on_failure_then_succeeds(self):
        ...
        with patch(
            "ncdev.core.sentinel_callback.httpx.post",
...
class TestSendFixResultException:
    ...
    def test_no_sleep_when_delay_is_zero(self):
        ...
        with patch("ncdev.core.sentinel_callback.httpx.post", return_value=mock_500):
            with patch("ncdev.core.sentinel_callback.time.sleep") as mock_sleep:
                from ncdev.core.sentinel_callback import send_fix_result
