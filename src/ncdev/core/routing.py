...
from ncdev.core.models import RoutingDecision, RoutingPlanDoc, TaskType
...
def _choose_model(config: NCDevConfig, provider_name: str, adapter: ProviderAdapter, task_type: TaskType) -> str:
...
def resolve_routing_plan(config: NCDevConfig, registry: dict[str, ProviderAdapter]) -> RoutingPlanDoc:
    task_types = [
