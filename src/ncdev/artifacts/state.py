...
def ensure_v2_schema_files(workspace: Path) -> None:
    ...
    schema_map: dict[str, dict[str, Any]] = {
        ...
        "design-brief.v2.json": DesignBriefDoc.model_json_schema(),
        "build-plan.v2.json": BuildPlanDoc.model_json_schema(),
        "phase-plan.v2.json": PhasePlanDoc.model_json_schema(),
        ...
        "bootstrap-run.v2.json": BootstrapRunDoc.model_json_schema(),
        "verification-run.v2.json": VerificationRunDoc.model_json_schema(),
        "evidence-index.v2.json": EvidenceIndexDoc.model_json_schema(),
        "verification-issues.v2.json": VerificationIssueBundleDoc.model_json_schema(),
        "delivery-summary.v2.json": DeliverySummaryDoc.model_json_schema(),
        "full-run-report.v2.json": FullRunReportDoc.model_json_schema(),
